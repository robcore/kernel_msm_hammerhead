...
static struct acpu_level acpu_freq_tbl_2p3g_pvs0[] __initdata = {
	...
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  825000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  835000, 180 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(8),  855000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  865000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  875000, 264 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(12),  900000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(16),  915000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(17),  950000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(18),  965000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  995000, 482 },
	...
	{ 1, { 2457600, HFPLL, 1, 130 }, L2(19), 1145000, 761 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs1[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  800000,  72 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  800000, 101 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  810000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  820000, 180 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(8),  840000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  850000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  860000, 264 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(12),  885000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(16),  895000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(17),  930000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(18),  945000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  975000, 482 },
	...
	{ 1, { 2457600, HFPLL, 1, 130 }, L2(19), 1125000, 761 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs2[] __initdata = {
	...
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  795000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  805000, 180 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(8),  825000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  835000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  845000, 264 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(12),  865000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(16),  875000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(17),  910000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(18),  925000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  955000, 482 },
	...
	{ 1, { 2457600, HFPLL, 1, 130 }, L2(19), 1100000, 761 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs3[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  72 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  775000, 101 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  780000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  790000, 180 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(8),  810000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  820000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  830000, 264 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(12),  850000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(16),  860000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(17),  895000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(18),  910000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  935000, 482 },
	...
	{ 1, { 2457600, HFPLL, 1, 130 }, L2(19), 1075000, 761 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs4[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  775000,  72 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  775000, 101 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  775000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  780000, 180 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(8),  800000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  810000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  820000, 264 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(12),  840000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(16),  850000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(17),  880000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(18),  895000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  920000, 482 },
	...
	{ 1, { 2457600, HFPLL, 1, 130 }, L2(19), 1050000, 761 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs5[] __initdata = {
	...
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  760000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  770000, 180 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(8),  790000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  800000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  810000, 264 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(12),  830000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(16),  840000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(17),  870000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(18),  880000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  900000, 482 },
	...
	{ 1, { 2457600, HFPLL, 1, 130 }, L2(19), 1025000, 761 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p3g_pvs6[] __initdata = {
	{ 1, {  300000, PLL_0, 0,   0 },  L2(0),  750000,  72 },
	{ 1, {  422400, HFPLL, 2,  44 },  L2(2),  750000, 101 },
	{ 1, {  652800, HFPLL, 1,  34 },  L2(5),  750000, 159 },
	{ 1, {  729600, HFPLL, 1,  38 },  L2(6),  760000, 180 },
	{ 1, {  883200, HFPLL, 1,  46 },  L2(8),  780000, 221 },
	{ 1, {  960000, HFPLL, 1,  50 },  L2(9),  790000, 242 },
	{ 1, { 1036800, HFPLL, 1,  54 }, L2(10),  800000, 264 },
	{ 1, { 1190400, HFPLL, 1,  62 }, L2(12),  820000, 308 },
	{ 1, { 1267200, HFPLL, 1,  66 }, L2(16),  830000, 333 },
	{ 1, { 1497600, HFPLL, 1,  78 }, L2(17),  860000, 404 },
	{ 1, { 1574400, HFPLL, 1,  82 }, L2(18),  870000, 430 },
	{ 1, { 1728000, HFPLL, 1,  90 }, L2(19),  885000, 482 },
	...
	{ 1, { 2457600, HFPLL, 1, 130 }, L2(19), 1000000, 761 },
	{ 0, { 0 } }
};
