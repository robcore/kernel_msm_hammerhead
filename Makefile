...
HOSTCC       = $(CCACHE) gcc
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes -Ofast -fomit-frame-pointer -fgcse-las $(GRAPHITE)
...
KBUILD_CFLAGS	+= -Ofast $(GRAPHITE) $(call cc-disable-warning,maybe-uninitialized,)
endif
